...
SDK_PATH := ../../SDK/yunrongtianshang/baidu
MAIN_SRC := ../../jni/ddtank
INCLUDE_SUPPORT_PATH := $(LOCAL_PATH)/../../../support
INCLUDE_SDK_PATH := $(LOCAL_PATH)/../../SDK/yunrongtianshang/baidu
INCLUDE_COCOS2DX_PATH := $(LOCAL_PATH)/../../../../cocos2d-x



include $(CLEAR_VARS)  
LOCAL_MODULE := libbd_wsp_v1_0
LOCAL_SRC_FILES := $(SDK_PATH)/so/libbd_wsp_v1_0.so         
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS)  
LOCAL_MODULE := libby-sdk-root-jni
LOCAL_SRC_FILES := $(SDK_PATH)/so/libby-sdk-root-jni.so         
include $(PREBUILT_SHARED_LIBRARY)
...
LOCAL_SRC_FILES := $(SDK_PATH)/so/libsapi_so_1.so         
include $(PREBUILT_SHARED_LIBRARY)
...
LOCAL_SRC_FILES += $(SDK_PATH)/cpp/CDKSdkForLua.cpp
