...
SDK_PATH := ../../SDK/yunrongtianshang/haima
MAIN_SRC := ../../jni/ddtank
INCLUDE_SUPPORT_PATH := $(LOCAL_PATH)/../../../support
INCLUDE_SDK_PATH := $(LOCAL_PATH)/../../SDK/yunrongtianshang/haima
...
LOCAL_SRC_FILES := $(SDK_PATH)/so/libbdpush_V2_2.so         
include $(PREBUILT_SHARED_LIBRARY)
...
LOCAL_SRC_FILES += $(SDK_PATH)/cpp/HAIMASdkForLua.cpp
