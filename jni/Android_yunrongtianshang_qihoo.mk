...
SDK_PATH := ../../SDK/yunrongtianshang/qihoo
MAIN_SRC := ../../jni/ddtank
INCLUDE_SUPPORT_PATH := $(LOCAL_PATH)/../../../support
INCLUDE_SDK_PATH := $(LOCAL_PATH)/../../SDK/yunrongtianshang/qihoo
...
LOCAL_SRC_FILES += $(SDK_PATH)/cpp/QHSdkForLua.cpp
LOCAL_SRC_FILES += $(SDK_PATH)/cpp/CQHGameSdk.cpp
