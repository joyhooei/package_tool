...
SDK_PATH := ../../SDK/huaqingfeiyang/yingyongbao
MAIN_SRC := ../../jni/ddtank
INCLUDE_SUPPORT_PATH := $(LOCAL_PATH)/../../../support
INCLUDE_SDK_PATH := $(LOCAL_PATH)/../../SDK/huaqingfeiyang/yingyongbao
...
LOCAL_SRC_FILES := $(SDK_PATH)/so/libBugly.so         
...
LOCAL_CPPFLAGS += -DSDK_YINGYONGBAO
LOCAL_CPPFLAGS += -DQUDAO__HUAQINGFEIYANG
...
LOCAL_SRC_FILES += $(SDK_PATH)/cpp/YINGYONGBAOSdkForLua.cpp
