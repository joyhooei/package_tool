...
SDK_PATH := ../../SDK/yunrongtianshang/pps
MAIN_SRC := ../../jni/ddtank
INCLUDE_SUPPORT_PATH := $(LOCAL_PATH)/../../../support
INCLUDE_SDK_PATH := $(LOCAL_PATH)/../../SDK/yunrongtianshang/pps
...
LOCAL_SRC_FILES += $(SDK_PATH)/cpp/PPSSdkForLua.cpp
