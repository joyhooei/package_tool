...
SDK_PATH := ../../SDK/yunrongtianshang/m4399
MAIN_SRC := ../../jni/ddtank
INCLUDE_SUPPORT_PATH := $(LOCAL_PATH)/../../../support
INCLUDE_SDK_PATH := $(LOCAL_PATH)/../../SDK/yunrongtianshang/m4399
INCLUDE_COCOS2DX_PATH := $(LOCAL_PATH)/../../../../cocos2d-x


include $(CLEAR_VARS)  
LOCAL_MODULE := libdmsmsiap
LOCAL_SRC_FILES := $(SDK_PATH)/so/libdmsmsiap.so           
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS)  
LOCAL_MODULE := libxdelta
LOCAL_SRC_FILES := $(SDK_PATH)/so/libxdelta.so           
include $(PREBUILT_SHARED_LIBRARY)
...
LOCAL_SRC_FILES += $(SDK_PATH)/cpp/M4399SdkForLua.cpp
