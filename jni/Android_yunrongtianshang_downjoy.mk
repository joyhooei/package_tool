...
SDK_PATH := ../../SDK/yunrongtianshang/downjoy
MAIN_SRC := ../../jni/ddtank
INCLUDE_SUPPORT_PATH := $(LOCAL_PATH)/../../../support
INCLUDE_SDK_PATH := $(LOCAL_PATH)/../../SDK/yunrongtianshang/downjoy
INCLUDE_COCOS2DX_PATH := $(LOCAL_PATH)/../../../../cocos2d-x


include $(CLEAR_VARS)  
LOCAL_MODULE := libdcn_encypt
LOCAL_SRC_FILES := $(SDK_PATH)/so/libdcn_encypt.so         
...
LOCAL_SRC_FILES += $(SDK_PATH)/cpp/DownJoySdkForLua.cpp
