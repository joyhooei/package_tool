...
SDK_PATH := ../../SDK/yunrongtianshang/kugou
MAIN_SRC := ../../jni/ddtank
INCLUDE_SUPPORT_PATH := $(LOCAL_PATH)/../../../support
INCLUDE_SDK_PATH := $(LOCAL_PATH)/../../SDK/yunrongtianshang/kugou
...
include $(CLEAR_VARS)  
LOCAL_MODULE := libkeys
LOCAL_SRC_FILES := $(SDK_PATH)/so/libkeys.so        
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS)  
LOCAL_MODULE := liblocSDK3
LOCAL_SRC_FILES := $(SDK_PATH)/so/liblocSDK3.so        
include $(PREBUILT_SHARED_LIBRARY)
...
LOCAL_SRC_FILES += $(SDK_PATH)/cpp/KUGOUSdkForLua.cpp
