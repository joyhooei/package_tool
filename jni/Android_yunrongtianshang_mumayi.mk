...
SDK_PATH := ../../SDK/yunrongtianshang/mumayi
MAIN_SRC := ../../jni/ddtank
INCLUDE_SUPPORT_PATH := $(LOCAL_PATH)/../../../support
INCLUDE_SDK_PATH := $(LOCAL_PATH)/../../SDK/yunrongtianshang/mumayi
...
include $(CLEAR_VARS)  
LOCAL_MODULE := libapkpatch
LOCAL_SRC_FILES := $(SDK_PATH)/so/libapkpatch.so        
include $(PREBUILT_SHARED_LIBRARY)
...
LOCAL_SRC_FILES += $(SDK_PATH)/cpp/MUMAYISdkForLua.cpp
