...
SDK_PATH := ../../SDK/yunrongtianshang/muzhiwan
MAIN_SRC := ../../jni/ddtank
INCLUDE_SUPPORT_PATH := $(LOCAL_PATH)/../../../support
INCLUDE_SDK_PATH := $(LOCAL_PATH)/../../SDK/yunrongtianshang/muzhiwan
...
LOCAL_SRC_FILES += $(SDK_PATH)/cpp/MUZHIWANSdkForLua.cpp
