...
SDK_PATH := ../../SDK/yunrongtianshang/ouwan
MAIN_SRC := ../../jni/ddtank
INCLUDE_SUPPORT_PATH := $(LOCAL_PATH)/../../../support
INCLUDE_SDK_PATH := $(LOCAL_PATH)/../../SDK/yunrongtianshang/ouwan
...
include $(CLEAR_VARS)  
LOCAL_MODULE := libmppay
LOCAL_SRC_FILES := $(SDK_PATH)/so/libmppay.so         
include $(PREBUILT_SHARED_LIBRARY)
...
LOCAL_SRC_FILES += $(SDK_PATH)/cpp/OUWANSdkForLua.cpp
